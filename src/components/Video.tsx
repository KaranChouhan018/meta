  ...
  return (
    <div className="w-screen h-screen relative">
      ...
      <div ref={titleRef} className="relative z-10 w-full h-full flex flex-col justify-center items-center text-center gap-10 px-4">
        ...
        <div 
          className={`flex flex-col md:flex-row md:justify-center items-center gap-4 md:gap-6 transition-all duration-500 ${
            showCarousel ? 'flex-row justify-start p-4 w-screen' : 'flex-col'
          }`}
        >
